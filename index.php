                    ...
                    <div class="form-container">
                        <form id="formf1" action="submit_form.php" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control custfield " name="entry.1884265043"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 floatershadow animation-element slide-down">
                    ...
                    <div class="row justify-content-center animation-element slide-down">
                        ...
                        <div
                            class="col-lg-1 col-auto allcol d-flex align-self-center justify-content-center order-lg-1">
                            <a id="gallerycarouselleft" class="arrowbox">
                                <span class="icon-left-arrow" aria-hidden="true"></span>
                            </a>
                        </div>
                        <div
                            class="col-lg-1 col-auto allcol d-flex align-self-center justify-content-center order-lg-3">
                ...
                <div class="col-lg-10 col-8">
                    <div class="row testOfferSlider ">
                        ...
                        <div class="col-lg-2">
                            <div class="testOffer-wrapper-div text-center m-4">
                                <div class="icon-div">
                                 <span class="icon-heart  testOffer-icon"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span><span class="path7"></span><span class="path8"></span><span class="path9"></span><span class="path10"></span><span class="path11"></span></span>
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="testOffer-wrapper-div text-center m-4">
                                <div class="icon-div">
                                 <span class="icon-endocrine testOffer-icon"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></span>
                                </div>
                        ...
                        <div class="col-lg-2">
                           <div class="testOffer-wrapper-div text-center m-4">
                               <div class="icon-div">
                                 <span class="icon-glucose-meter testOffer-icon"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span><span class="path7"></span><span class="path8"></span><span class="path9"></span><span class="path10"></span><span class="path11"></span><span class="path12"></span><span class="path13"></span><span class="path14"></span><span class="path15"></span><span class="path16"></span><span class="path17"></span><span class="path18"></span><span class="path19"></span><span class="path20"></span><span class="path21"></span><span class="path22"></span><span class="path23"></span><span class="path24"></span><span class="path25"></span><span class="path26"></span><span class="path27"></span><span class="path28"></span><span class="path29"></span><span class="path30"></span><span class="path31"></span></span>
                               </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center" data-aos="fade-left">
                <div class="col-lg-3 col-md-4 mt-4">
                    <span><img src="assets/images/star-yellow.png" alt="" class="img-fluid"
                            width="20px"></span>
                    <span><img src="assets/images/star-yellow.png" alt="" class="img-fluid"
                            width="20px"></span>
                    <span><img src="assets/images/star-yellow.png" alt="" class="img-fluid"
                    ...
                    <span><img src="assets/img/star.png" alt="" class="img-fluid" width="20px"></span>
                    <p class="mt-3">"Nice facility nice staff."</p>
                    <h5>-Amarlal Yadav</h5>
                </div>
                <div class="col-lg-3 col-md-4 mt-4">
                    <span><img src="assets/images/star-yellow.png" alt="" class="img-fluid"
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <span><img src="assets/img/star.png" alt="" class="img-fluid" width="20px"></span>
                    <span><img src="assets/img/star.png" alt="" class="img-fluid" width="20px"></span>
                    <p class="mt-3">"Their pathology is too good but the new sonography doctor gas little experience
                        at least
                        with pregnancy tests. Sonography tests need prior appointments and it's really painful to book
                        appointment via their call center"</p>
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    ...
                    <span><img src="assets/img/star-yellow.png" alt="" class="img-fluid"
                            width="20px"></span>
                    <p class="mt-3">"Superb Service.. Highly Satisfied."</p>
                    <h5>-Rohit Dubey</h5>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row align-self-center justify-content-center footer-text allcol">
                <div class="col-lg-4 align-self-center">
                    <p class="section-subtext">
                        Call - <span><a class="numlink important-white"
                                href="tel:+91-9967754237">+91-9967754237</a></span>
                    </p>
                    <p><br><br></p>
                </div>
