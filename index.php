         ...
         <div class="row justify-content-center">
            <div class="col-lg-10 allcol text-center">
               ...
               <p class="animation-element slide-right">
                  Lilawati diagnsotic & lab center have dedicated team of medically-equipped and trained professionals
                  in home healthcare. We have vast range of medical test available for your convenient just book in
      ...
      <div class="container-fluid">
         ...
         <div class="row justify-content-center" data-aos="fade-left">
            ...
            <div class="col-lg-3 col-md-4 mt-4">
               ...
               <span><img src="assets/img/star.png" alt="" class="img-fluid" width="20px"></span>
               <span><img src="assets/img/star.png" alt="" class="img-fluid" width="20px"></span>
               <p class="mt-3">"Their pathology is too good but the new sonography doctor gas little experience at least
         ...
         <div class="row justify-content-center allcol">
            <div class="col-lg-5 allcol text-center animation-element slide-right" id="officeaddr">
               ...
               <p class="section-subtext">
                  Lilawati Diagnostic Center, Shop No. 7, next to Famous Bakery M.G. School Link Road, Behram Baug,
            ...
            <div class="col-lg-6 timing">
               <p class="addresstext black-header">
                  <span class="icon-clock timeIcon"></span> <span class="timeIconText">Monday - Sunday 24 X 7</span>
               </p>
               <p class="addresstext black-header">
